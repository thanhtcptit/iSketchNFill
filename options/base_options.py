...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='wgangp_sparse_label_channel_pix2pix_autocomplete_multiscale_nz_256_nc_1_nf_32_gp_0_multigpu', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='../checkpoints_sparse', help='models are saved here')
        ...
        self.parser.add_argument('--num_interpolate', type=int, default=8, help='Number of channels in the images')
